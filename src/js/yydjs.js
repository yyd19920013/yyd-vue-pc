...
function axiosWrap(config){
    ...
    function createAxios(config){
        var url=(hostname=='localhost'||hostname=='127.0.0.1'||hostname=='172.16.21.92')?config.url:config.url.replace('/api');
